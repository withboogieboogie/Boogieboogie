  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          if (isKeyboardVisible &&
              !_isExpanded) // 키보드가 올라와 있고 채팅창이 축소된 상태일 때는 캐릭터만 표시
            Expanded(
              flex: 7,
              child: Center(
                child: Image.asset(
              ...
              !_isExpanded) // 키보드가 내려가 있고 채팅창이 축소된 상태일 때 일부 채팅과 캐릭터 모두 표시
            Expanded(
              flex: 5,
              child: Column(
                children: [
              ...
              _isExpanded) // 키보드가 내려가 있고 채팅창이 확장된 상태일 때 캐릭터 숨기기
            Expanded(
              flex: 10,
              child: Container(
                padding: const EdgeInsets.symmetric(horizontal: 16),
              ...
              _isExpanded) // 키보드가 올라오고 채팅창이 확장된 상태일 때 확장된 채팅창만 표시
            Expanded(
              flex: 10,
              child: Container(
                padding: const EdgeInsets.symmetric(horizontal: 16),
      ...
      bottomNavigationBar: const CustomBottomNavigationBar(
        selectedIndex: 1, // 채팅 페이지에 해당하는 인덱스 설정
      ),
    );
  }
}